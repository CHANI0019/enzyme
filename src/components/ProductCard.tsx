  ...
  return (
    ...
    >
      <div className="relative aspect-square overflow-hidden bg-slate-100">
        ...
        />
        {product.tag && (
          <span className={`absolute top-3 left-3 text-white text-[10px] uppercase tracking-widest font-bold px-2 py-1 rounded ${
            product.tag === 'Best' ? 'bg-primary' : 
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <div className="mt-auto flex items-center justify-between">
          <span className="text-primary font-extrabold text-xl">${product.price.toFixed(2)}</span>
